  ...
  Font.prototype = {
    ...
    checkAndRepair: function Font_checkAndRepair(name, font, properties) {
      ...
      function sanitizeGlyphLocations(
        ...
        // ----------------------------- tanglinhai start ------------------------------
        /*console.log('==111111============1:', JSON.stringify(locaEntries[4559]));
        console.log('==111111============2:', JSON.stringify(locaEntries[4560]));
        console.log('==111111============3:', JSON.stringify(locaEntries[4561]));
        locaEntries.sort((a, b) => {
          return a.offset - b.offset;
        });
        console.log('==222222============1:', JSON.stringify(locaEntries[4559]));
        console.log('==222222============2:', JSON.stringify(locaEntries[4560]));
        console.log('==222222============3:', JSON.stringify(locaEntries[4561]));*/
        // ----------------------------- tanglinhai end ------------------------------
