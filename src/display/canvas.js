  ...
  CanvasGraphics.prototype = {
    ...
    showText: function CanvasGraphics_showText(glyphs) {
      ...
      for (i = 0; i < glyphsLength; ++i) {
        ...
        // console.log('1---------------------character:'+character+', scaledX:'+scaledX+', scaledY:'+scaledY+', unicode:'+glyph.unicode+', contentVisible:'+this.contentVisible+', isInFont:'+glyph.isInFont+', missingFile:'+glyph.missingFile);
        var charWidth;
        if (vertical) {
